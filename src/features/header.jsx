...
export default function Header() {
  ...
  return (
    <header className="relative z-40 block w-full backdrop-blur backdrop-brightness-75">
      {/* Desktop */}
        ...
        <div className="flex flex-row items-center justify-between w-full px-5">
          <div className="flex items-center justify-start grow">
            <Link href="#home" className="flex items-center w-auto h-full tracking-normal text-primary">
              <Image src="/images/logo.webp" width={470} height={441} className="relative w-auto h-16 py-3 m-auto" alt={t("globals.header") || "Aquadoge logo"} />
            </Link>
          </div>
      ...
      {/* Mobile */} 
      <div className={cx("flex flex-col w-full lg:hidden", { "h-screen bg-[#000000aa]": menuVisible })}>
